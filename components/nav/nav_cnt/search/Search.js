...
const Search = () => {
  ...
  function serverRouting() {
    ...
    for (i = 0; i < STORE_KWS.length; i++) {
      if (searchIptVal.indexOf(STORE_KWS[i]) > -1) {
        router.push("/next-projects/afreshplace/store");
      }
    }

    for (i = 0; i < ABOUT_KWS.length; i++) {
      if (searchIptVal.indexOf(ABOUT_KWS[i]) > -1) {
        router.push("/next-projects/afreshplace/about");
      }
    }

    for (i = 0; i < MEAT_KWS.length; i++) {
      if (searchIptVal.indexOf(MEAT_KWS[i]) > -1) {
        router.push("/next-projects/afreshplace/store/meats");
      }
    }

    for (i = 0; i < FRUIT_KWS.length; i++) {
      if (searchIptVal.indexOf(FRUIT_KWS[i]) > -1) {
        router.push("/next-projects/afreshplace/store/fruits");
      }
    }

    for (i = 0; i < VEGGIES_KWS.length; i++) {
      if (searchIptVal.indexOf(VEGGIES_KWS[i]) > -1) {
        router.push("/next-projects/afreshplace/store/veggies");
      }
    }

    for (i = 0; i < DESSERT_KWS.length; i++) {
      if (searchIptVal.indexOf(DESSERT_KWS[i]) > -1) {
        router.push("/next-projects/afreshplace/store/desserts");
      }
    }
  }
      ...
      <div id="searchCnt" className={styles.search_cnt}>
        <div className={styles.search_cnt_inner}>
          ...
          <div className={styles.search_cnt_inner_main}>
            ...
            <ul id="searchLinks">
              <li>
                <Link href="http://basicallyeasy.com/next-projects/afreshplace/">
                  <a className="page-transition">Home</a>
                </Link>
              </li>
              <li>
                <Link href="http://basicallyeasy.com/next-projects/afreshplace/store/">
                  <a className="page-transition">All Products</a>
                </Link>
              </li>
              <li>
                <Link href="http://basicallyeasy.com/next-projects/afreshplace/store/meats/">
                  <a className="page-transition">All Meats</a>
                </Link>
              </li>
              <li>
                <Link href="http://basicallyeasy.com/next-projects/afreshplace/store/fruits/">
                  <a className="page-transition">All Fruits</a>
                </Link>
              </li>
              <li>
                <Link href="http://basicallyeasy.com/next-projects/afreshplace/store/veggies/">
                  <a className="page-transition">All Veggies</a>
                </Link>
              </li>
              <li>
                <Link href="http://basicallyeasy.com/next-projects/afreshplace/store/desserts/">
                  <a className="page-transition">All Desserts</a>
                </Link>
              </li>
              <li>
                <Link href="http://basicallyeasy.com/next-projects/afreshplace/about/">
                  <a className="page-transition">About Us</a>
                </Link>
              </li>
              <li>
                <Link href="http://basicallyeasy.com/next-projects/afreshplace/support/">
