      ...
      >
        ...
        >
          <div className={styles.store_product_types_side_cnt}>
            <img
              data-src={`http://basicallyeasy.com/NextJSCDNS/afreshplace/store/index/${props.storeProductIMG}`}
      ...
      <div id={styles.storeProductTypes}>
        ...
        >
          <this.createProductType
            ...
            storeProductHREF="/next-projects/afreshplace/store/meats/"
          />
        </div>
        <div
          className={`${styles.store_product_types_box} container-fluid`}
        ...
        >
          <this.createProductType
            ...
            storeProductHREF="/next-projects/afreshplace/store/fruits/"
          />
        </div>
        <div
          className={`${styles.store_product_types_box} container-fluid`}
        ...
        >
          <this.createProductType
            ...
            storeProductHREF="/next-projects/afreshplace/store/veggies/"
          />
        </div>
        <div
          className={`${styles.store_product_types_box} container-fluid`}
        ...
        >
          <this.createProductType
            ...
            storeProductHREF="/next-projects/afreshplace/store/desserts/"
          />
        </div>
      </div>
    );
