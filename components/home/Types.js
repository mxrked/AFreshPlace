    ...
    <div id={styles.indexTypes}>
      ...
      >
        <div className={`${styles.index_types_row} row`}>
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/afreshplace/store/meats/meat-bg.webp"
              width="110%"
              height="110%"
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/afreshplace/store/fruit/fruit-bg.webp"
              width="110%"
              height="110%"
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/afreshplace/store/veggies/veggies-bg.webp"
              width="110%"
              height="110%"
          ...
          >
            <BackgroundImage
              src="http://basicallyeasy.com/NextJSCDNS/afreshplace/store/desserts/dessert-bg.webp"
              width="110%"
              height="110%"
