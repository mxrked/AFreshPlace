      ...
      >
        ...
        <div className={`${styles.index_benefits_box} container-fluid`}>
          <div className={`${styles.index_benefits_row} row`}>
            ...
            >
              <img
                data-src="http://basicallyeasy.com/NextJSCDNS/afreshplace/index/benefits/fresh.png"
            ...
            >
              <img
                data-src="http://basicallyeasy.com/NextJSCDNS/afreshplace/index/benefits/cooking.png"
                className="lazyload blur_up"
            ...
            >
              <img
                data-src="http://basicallyeasy.com/NextJSCDNS/afreshplace/index/benefits/happy.png"
                className="lazyload blur_up"
