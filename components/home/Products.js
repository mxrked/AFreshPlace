          ...
          <Slider {...productsSettings}>
            ...
            <div className={`${styles.products_slide} page-transition`}>
              <div className={styles.products_slide_cnt}>
                <img
                  data-src="http://basicallyeasy.com/NextJSCDNS/afreshplace/store/meats/lobster.png"
            ...
            <div className={`${styles.products_slide} page-transition`}>
              <div className={styles.products_slide_cnt}>
                <img
                  data-src="http://basicallyeasy.com/NextJSCDNS/afreshplace/store/meats/steak.png"
                  className="lazyload blur_up"
                  alt="Steak"
                />
            ...
            <div className={`${styles.products_slide} page-transition`}>
              <div className={styles.products_slide_cnt}>
                <img
                  data-src="http://basicallyeasy.com/NextJSCDNS/afreshplace/store/meats/chicken.png"
                  className="lazyload blur_up"
                  alt="Chicken"
                />
            ...
            <div className={`${styles.products_slide} page-transition`}>
              <div className={styles.products_slide_cnt}>
                <img
                  data-src="http://basicallyeasy.com/NextJSCDNS/afreshplace/store/fruit/apple.png"
                  className="lazyload blur_up"
                  alt="Apple"
                />
            ...
            <div className={`${styles.products_slide} page-transition`}>
              <div className={styles.products_slide_cnt}>
                <img
                  data-src="http://basicallyeasy.com/NextJSCDNS/afreshplace/store/fruit/banana.png"
                  className="lazyload blur_up"
                  alt="Banana"
                />
            ...
            <div className={`${styles.products_slide} page-transition`}>
              <div className={styles.products_slide_cnt}>
                <img
                  data-src="http://basicallyeasy.com/NextJSCDNS/afreshplace/store/fruit/strawberries.png"
                  className="lazyload blur_up"
                  alt="Strawberries"
                />
            ...
            <div className={`${styles.products_slide} page-transition`}>
              <div className={styles.products_slide_cnt}>
                <img
                  data-src="http://basicallyeasy.com/NextJSCDNS/afreshplace/store/veggies/asparagus.png"
                  className="lazyload blur_up"
                  alt="Asparagus"
                />
            ...
            <div className={`${styles.products_slide} page-transition`}>
              <div className={styles.products_slide_cnt}>
                <img
                  data-src="http://basicallyeasy.com/NextJSCDNS/afreshplace/store/veggies/bell-peppers.png"
                  className="lazyload blur_up"
                  alt="Bell Peppers"
                />
            ...
            <div className={`${styles.products_slide} page-transition`}>
              <div className={styles.products_slide_cnt}>
                <img
                  data-src="http://basicallyeasy.com/NextJSCDNS/afreshplace/store/veggies/corn.png"
                  className="lazyload blur_up"
                  alt="Corn"
                />
            ...
            <div className={`${styles.products_slide} page-transition`}>
              <div className={styles.products_slide_cnt}>
                <img
                  data-src="http://basicallyeasy.com/NextJSCDNS/afreshplace/store/desserts/chocolate-cake.png"
                  className="lazyload blur_up"
                  alt="Chocolate Cake"
                />
            ...
            <div className={`${styles.products_slide} page-transition`}>
              <div className={styles.products_slide_cnt}>
                <img
                  data-src="http://basicallyeasy.com/NextJSCDNS/afreshplace/store/desserts/keylime-pie.png"
                  className="lazyload blur_up"
                  alt="Keylime Pie"
                />
            ...
            <div className={`${styles.products_slide} page-transition`}>
              <div className={styles.products_slide_cnt}>
                <img
                  data-src="http://basicallyeasy.com/NextJSCDNS/afreshplace/store/desserts/mochi-bites.png"
                  className="lazyload blur_up"
                  alt="Mochi"
                />
